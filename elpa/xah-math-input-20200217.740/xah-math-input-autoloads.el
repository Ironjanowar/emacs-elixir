...
(put 'global-xah-math-input-mode 'globalized-minor-mode t)
...
Turn on `xah-math-input-mode' in current buffer." t nil)

(autoload 'xah-math-input-mode-off "xah-math-input" "\
Turn off `xah-math-input-mode' in current buffer." t nil)

(autoload 'xah-math-input-mode "xah-math-input" "\
Toggle xah-math-input minor mode.

If called interactively, enable Xah-Math-Input mode if ARG is

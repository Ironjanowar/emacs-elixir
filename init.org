...
#+BEGIN_SRC elisp :tangle ./settings/verb-config.el :mkdirp yes
  ...
  (defun shopify-query (rs)
    "Convert RS to a GraphQL query."
    (shopify--convert-to-graphql rs "query"))

  (defun shopify-mutation (rs)
    "Convert RS to a GraphQL mutation."
    (shopify--convert-to-graphql rs "mutation"))

  (defun shopify--convert-to-graphql (rs type)
